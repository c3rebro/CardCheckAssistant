...
namespace CardCheckAssistant.Extensions
{
    /// <summary>
    ...
    public sealed class EnumerateExtension : MarkupExtension
    {
        ...
        public EnumerateExtension(Type type)
        {
            ...
            cultureInfo = (new DefaultSettings().DefaultLanguage == "german") ? new CultureInfo("de") : new CultureInfo("en");
        }
        ...
        public static string GetResource(string resName)
        {
            try
            {
                using (var settings = new SettingsReaderWriter())
                {
                    ...
                    var ressource = new ResourceManager("CardCheckAssistant.Resources.Manifest", System.Reflection.Assembly.GetExecutingAssembly())
                        .GetString(resName, (settings.DefaultSettings.DefaultLanguage == "german") ? new CultureInfo("de") : new CultureInfo("en"));
